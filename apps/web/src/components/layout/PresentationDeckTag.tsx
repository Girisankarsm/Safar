...
export function PresentationDeckTag({
  ...
  return (
    <a
      ...
      className={cn(
        "inline-flex items-center gap-1.5 rounded-full border border-[#3B82F6]/30 bg-[#3B82F6]/10 font-semibold text-[#93C5FD] transition hover:border-[#3B82F6]/50 hover:bg-[#3B82F6]/15",
