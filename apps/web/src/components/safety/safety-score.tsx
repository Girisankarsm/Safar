...
export function SafetyScore({
  ...
  return (
    <div className="flex items-center gap-3">
      <div
        className={cn(
          "flex items-center justify-center rounded-2xl border-2 bg-surface font-bold",
          ring,
          sizes[size]
        )}
      >
      ...
      {showLabel && (
        <div>
          <p className="text-[10px] font-semibold uppercase tracking-wider text-muted">Safety</p>
